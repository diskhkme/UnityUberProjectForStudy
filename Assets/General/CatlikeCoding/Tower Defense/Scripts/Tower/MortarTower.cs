...
namespace Defense
{
    public class MortarTower : Tower
    {
        ...
        [SerializeField, Range(0.5f, 3f)] float shellBlastRadius = 1f; //radius, damage 데이터 관리는 여기에서, 동작은 shell에서
        ...
        void OnValidate()
        {
            float x = targetingRange + 0.25001f; //적의 collider radius(0.25) + epsilon(0.00001)
