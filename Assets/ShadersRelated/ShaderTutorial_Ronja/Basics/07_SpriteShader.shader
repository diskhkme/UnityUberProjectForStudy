Shader "Tutorial/07_SpriteShader"
{
	Properties{
    ...
    SubShader
    {
		...
		ZWrite Off
		//Sprite Shader는 뒤집혀도 보여야 하기 때문에 Cull Off (backface culling 안함)
		Cull Off

		//Sprite가 Sprite order에 의해 그려지는 순서는 유니티가 알아서 결정
        ...
        Pass
        {
			...
			struct appdata { //Input data struct
				...
				fixed4 color : COLOR; // vertex color로 사용하는 데이터
			};
